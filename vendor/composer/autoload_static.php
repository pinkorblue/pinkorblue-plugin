...
class ComposerStaticInit5ebae18d44df391d24bcbd80849d2aa4
{
    ...
    public static $classMap = array (
        ...
        'Raven_Autoloader' => __DIR__ . '/..' . '/sentry/Autoloader.php',
        'Raven_Breadcrumbs' => __DIR__ . '/..' . '/sentry/Breadcrumbs.php',
        'Raven_Breadcrumbs_ErrorHandler' => __DIR__ . '/..' . '/sentry/Breadcrumbs/ErrorHandler.php',
        'Raven_Breadcrumbs_MonologHandler' => __DIR__ . '/..' . '/sentry/Breadcrumbs/MonologHandler.php',
        'Raven_Client' => __DIR__ . '/..' . '/sentry/Client.php',
        'Raven_Compat' => __DIR__ . '/..' . '/sentry/Compat.php',
        'Raven_Context' => __DIR__ . '/..' . '/sentry/Context.php',
        'Raven_CurlHandler' => __DIR__ . '/..' . '/sentry/CurlHandler.php',
        'Raven_ErrorHandler' => __DIR__ . '/..' . '/sentry/ErrorHandler.php',
        'Raven_Exception' => __DIR__ . '/..' . '/sentry/Exception.php',
        'Raven_Processor' => __DIR__ . '/..' . '/sentry/Processor.php',
        'Raven_Processor_RemoveCookiesProcessor' => __DIR__ . '/..' . '/sentry/Processor/RemoveCookiesProcessor.php',
        'Raven_Processor_RemoveHttpBodyProcessor' => __DIR__ . '/..' . '/sentry/Processor/RemoveHttpBodyProcessor.php',
        'Raven_Processor_SanitizeDataProcessor' => __DIR__ . '/..' . '/sentry/Processor/SanitizeDataProcessor.php',
        'Raven_Processor_SanitizeHttpHeadersProcessor' => __DIR__ . '/..' . '/sentry/Processor/SanitizeHttpHeadersProcessor.php',
        'Raven_Processor_SanitizeStacktraceProcessor' => __DIR__ . '/..' . '/sentry/Processor/SanitizeStacktraceProcessor.php',
        'Raven_ReprSerializer' => __DIR__ . '/..' . '/sentry/ReprSerializer.php',
        'Raven_SanitizeDataProcessor' => __DIR__ . '/..' . '/sentry/SanitizeDataProcessor.php',
        'Raven_Serializer' => __DIR__ . '/..' . '/sentry/Serializer.php',
        'Raven_Stacktrace' => __DIR__ . '/..' . '/sentry/Stacktrace.php',
        'Raven_TransactionStack' => __DIR__ . '/..' . '/sentry/TransactionStack.php',
        'Raven_Util' => __DIR__ . '/..' . '/sentry/Util.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInit5ebae18d44df391d24bcbd80849d2aa4::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInit5ebae18d44df391d24bcbd80849d2aa4::$prefixDirsPsr4;
            $loader->fallbackDirsPsr4 = ComposerStaticInit5ebae18d44df391d24bcbd80849d2aa4::$fallbackDirsPsr4;
            $loader->prefixesPsr0 = ComposerStaticInit5ebae18d44df391d24bcbd80849d2aa4::$prefixesPsr0;
            $loader->classMap = ComposerStaticInit5ebae18d44df391d24bcbd80849d2aa4::$classMap;
