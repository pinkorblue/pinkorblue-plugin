...
return array(
    ...
    'Raven_Autoloader' => $vendorDir . '/sentry/Autoloader.php',
    'Raven_Breadcrumbs' => $vendorDir . '/sentry/Breadcrumbs.php',
    'Raven_Breadcrumbs_ErrorHandler' => $vendorDir . '/sentry/Breadcrumbs/ErrorHandler.php',
    'Raven_Breadcrumbs_MonologHandler' => $vendorDir . '/sentry/Breadcrumbs/MonologHandler.php',
    'Raven_Client' => $vendorDir . '/sentry/Client.php',
    'Raven_Compat' => $vendorDir . '/sentry/Compat.php',
    'Raven_Context' => $vendorDir . '/sentry/Context.php',
    'Raven_CurlHandler' => $vendorDir . '/sentry/CurlHandler.php',
    'Raven_ErrorHandler' => $vendorDir . '/sentry/ErrorHandler.php',
    'Raven_Exception' => $vendorDir . '/sentry/Exception.php',
    'Raven_Processor' => $vendorDir . '/sentry/Processor.php',
    'Raven_Processor_RemoveCookiesProcessor' => $vendorDir . '/sentry/Processor/RemoveCookiesProcessor.php',
    'Raven_Processor_RemoveHttpBodyProcessor' => $vendorDir . '/sentry/Processor/RemoveHttpBodyProcessor.php',
    'Raven_Processor_SanitizeDataProcessor' => $vendorDir . '/sentry/Processor/SanitizeDataProcessor.php',
    'Raven_Processor_SanitizeHttpHeadersProcessor' => $vendorDir . '/sentry/Processor/SanitizeHttpHeadersProcessor.php',
    'Raven_Processor_SanitizeStacktraceProcessor' => $vendorDir . '/sentry/Processor/SanitizeStacktraceProcessor.php',
    'Raven_ReprSerializer' => $vendorDir . '/sentry/ReprSerializer.php',
    'Raven_SanitizeDataProcessor' => $vendorDir . '/sentry/SanitizeDataProcessor.php',
    'Raven_Serializer' => $vendorDir . '/sentry/Serializer.php',
    'Raven_Stacktrace' => $vendorDir . '/sentry/Stacktrace.php',
    'Raven_TransactionStack' => $vendorDir . '/sentry/TransactionStack.php',
    'Raven_Util' => $vendorDir . '/sentry/Util.php',
